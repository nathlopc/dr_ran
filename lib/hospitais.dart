...
class Hospitais extends StatefulWidget {
  ...
  void getList() {
    _hospitais.add(new HospitalModel("Hospital Geral de Clínicas de Rio Branco", "Av. Nações Unidas, 700 - Bosque, Rio Branco - AC, 69900-478", "(68) 3223-3080", "AC", "Rio Branco"));
    _hospitais.add(new HospitalModel("Hospital Escola Dr. Hélvio Auto", "R. Cônego Fernando Lyra, s/n - Trapiche da Barra, Maceió - AL, 57017-420", "(82) 3315-6826", "AL", "Maceió"));
    _hospitais.add(new HospitalModel("Instituto da Mulher Dona Lindu", "Av. Mário Ypiranga, 1581 - Adrianópolis, Manaus - AM, 69057-002", "(92) 3643-8100", "AM", "Manaus"));
    _hospitais.add(new HospitalModel("Hospital Infantil Dr. Fajardo", "Av. Joaquim Nabuco, 1886 - Centro, Manaus - AM, 69020-031", "(92) 3131-3606", "AM", "Manaus"));
    _hospitais.add(new HospitalModel("Hospital de Referencia Ana Braga", "Av. Cosme Ferreira, s/n - São José I, Manaus - AM, 69083-000", "(92) 3647-4200", "AM", "Manaus"));
    _hospitais.add(new HospitalModel("Hospital e Pronto Socorro da Criança Zona Leste", "Alameda Cosme Ferreira 3775 São José 1, Manaus - AM, 69082-230", "(92) 3647-1701", "AM", "Manaus"));
    _hospitais.add(new HospitalModel("Hospital Delphina Rinaldi Abdel Aziz", "Av. Torquato Tapajós, 9250 - Colônia Terra Nova, Manaus - AM, 69093-415", "(92) 3090-0500", "AM", "Manaus"));
    _hospitais.add(new HospitalModel("Instituto da Criança do Amazonas", "Av. Codajás, s/n - Cachoeirinha, Manaus - AM, 69065-130", "(92) 3612-4663", "AM", "Manaus"));
    _hospitais.add(new HospitalModel("Centro de Referência em Doenças Transmissíveis (CDT) do Hospital de Especialidades Dr. Alberto Lima", "R. Jovino Dinoá, 2004 - Macapá - AP, 68906-420", "-", "AP", "Macapá"));
    _hospitais.add(new HospitalModel("Instituto Couto Maia (ICON)", "R. Cel. Azevedo, S/N - Águas Claras, Salvador - BA, 41301-110", "(71) 3103-7150", "BA", "Salvador"));
    _hospitais.add(new HospitalModel("Hospital São José", "R. Nestor Barbosa, 315 - Parquelândia, Fortaleza - CE, 60455-610", "(85) 3101-2352", "CE", "Fortaleza"));
    _hospitais.add(new HospitalModel("Hospital Regional da Asa Norte", "SMHN Q 2 - Asa Norte, Brasília - DF, 70710-100", "(61) 2017-1900", "DF", "Brasília"));
    _hospitais.add(new HospitalModel("Hospital Estadual Jayme dos Santos Neves - HEJSN", "Av. Paulo Pereira Gomes, S/N - Morada de Laranjeiras, Serra - ES, 29166-828", "(27) 3331-7500", "ES", "Serra"));
    _hospitais.add(new HospitalModel("Hospital Infantil Nossa Senhora da Glória - HINSG", "Alameda Mari Ubirajara, 205 - Santa Lucia, Vitória - ES, 29056-030", "(27) 3198-7400", "ES", "Vitória"));
